                ...
                <div class="row row-cols-md-5 row-cols-2">
                    ...
                    <div class="col">
                        <div class="list-actor">
                            <a href="<?php echo actor($Listing['id'],$Listing['self']);?>" class="list-media" title="<?php echo $Listing['name'];?>">
                                <div class="media" data-src="<?php echo UPLOAD.'/actor/'.$Listing['image'];?>"></div>
                            </a>
                            <div class="list-caption">
                                <a href="<?php echo actor($Listing['id'],$Listing['self']);?>" class="list-title" title="<?php echo $Listing['name'];?>"><?php echo $Listing['name'];?></a> 
                            </div>
                        </div>
                    </div>
                    <?php } ?>
