...
<tbody>  
  		<tr>
    		<th style="font-size:12px;color:#fff;font-weight: 400;">Ticket Number</th>
    		<th class="report-title" style="font-size:12px;color:#fff;font-weight: 400;">Content</th>
  		...
  		<tr id="click-<?php echo $Report['id']; ?>" style="background-color:#101010;height:60px;line-height:60px;border-radius:5px;">
    		...
    		<th style="border: none;border-radius: 0px 5px 5px 0px;font-weight: 400;">
            	<a href="<?php echo $Report['url'];?>" target="_blank">
             	...
             	<?php if ($Report['status'] == 1) { echo '<span class="badge bg-warning-lt ml-2" style="float:right;padding:8px;margin-right:25px;margin-top:3px;">Resolved</span>'; } else { echo '<span class="badge bg-warning-lt ml-2" style="float:right;padding:8px;margin-right:25px;margin-top:3px;">Awaiting a solution</span>'; }?>
        	</th>
  		</tr>
    <?php } ?>
</tbody>
