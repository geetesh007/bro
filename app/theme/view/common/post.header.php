    ...
    <div class="embed-col">
		...
		<?php } ?>
         <?php } else { ?>
            ...
            <?php } else { ?>
            <div class="embed-cover lazy" data-src="<?php if(preg_match('/serie/',$Listing['type'])){ echo UPLOAD.'/episode/'.$Listing['self']; echo '-'; echo strtolower($Listing['season_name']); echo '-'.$Listing['episode_name']; } else { echo UPLOAD . '/cover/large-cover-' . $Listing['self']; }?>.webp"></div>
