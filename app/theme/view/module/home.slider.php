        ...
        <div id="slider" class="carousel slide carousel-fade" data-ride="carousel">
            <div class="carousel-inner">
                ...
                <div class="carousel-item <?php if($iSlider == 0) echo 'active';?>">
                    <a href="<?php if (empty($Slide['link'])) { echo post($Slide['id'],$Slide['self'],$Slide['type']);  } else { echo $Slide['link']; }?>" class="slide media media-slide" data-src="<?php echo UPLOAD.'/slide/'.$Slide['image'];?>">
