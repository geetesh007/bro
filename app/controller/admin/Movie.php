    ...
    public function update()
    {
        ...
        if (empty($Notify)) {
            ...
            if ($foo->uploaded) {
                ...
                $foo->allowed = array('image/*');
                $foo->file_auto_rename = true;
                $foo->file_new_name_body = Input::seo($_POST['title'].$Rand);
                $foo->image_resize = true;
                $foo->image_ratio_crop = true;
                $foo->image_x = MOVIE_X;
                $foo->image_y = MOVIE_Y;
                ...
                if ($foo->processed) {
                    ...
                    $thumb->allowed = array('image/*');
                    $thumb->file_auto_rename = true;
                    $thumb->file_new_name_body = 'thumb-' . Input::seo($_POST['title'].$Rand);
                    $thumb->image_resize = true;
                    $thumb->image_ratio_crop = true;
                    $thumb->image_x = THUMB_MOVIE_X;
                    $thumb->image_y = THUMB_MOVIE_Y;
            ...
            if ($foo->uploaded) {
                ...
                $foo->allowed = array('image/*');
                $foo->file_auto_rename = true;
                $foo->file_new_name_body = 'cover-'.Input::seo($_POST['title'].$Rand);
                $foo->image_resize = true;
                $foo->image_ratio_crop = true;
                $foo->image_x = COVER_X;
                $foo->image_y = COVER_Y;
