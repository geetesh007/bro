        ...
        <div id="c-<?php echo $Video['id'];?>" class="collapse" aria-labelledby="h-<?php echo $Video['id'];?>" data-parent="#accordionVideo">
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="video[<?php echo $Video['id'];?>][download]" value="<?php echo $Video['download'];?>" class="form-control" placeholder="<?php echo __('Download URL');?>" required="true">
                </div>
