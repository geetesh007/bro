        ...
        <tbody>
            ...
            <tr class="v-middle text-color">
                ...
                <td class="flex">
                    <a href="<?php echo APP.'/admin/'.$Config['page'].'/'.$Listing['id'];?>" class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <div class="text-12 text-muted"><?php echo $Listing['name'];?></div>
                        </div>
                    </a>
                </td>
                ...
                <td class="no-wrap table-link">
                    <a href="<?php echo APP.'/admin/episodes/'.$Listing['id'];?>">
                        <svg class="icon">
                            <use xlink:href="<?php echo ASSETS.'/img/sprite.svg#stream';?>" />
                        </svg>
                    </a>
