    ...
    <div class="d-md-flex">
        <div class="flex-fill">
            <div class="form-group">
                <label class="custom-label"><?php echo __('Episode');?></label>
                <input type="number" name="name" class="form-control" placeholder="<?php echo __('Episode');?>" required="true" value="<?php echo $Listing['name'];?>">
            </div>
            <div class="form-group">
                <label class="custom-label"><?php echo __('Overview');?></label>
                <input type="text" name="description" class="form-control" placeholder="<?php echo __('Overview');?>" value="<?php echo $Listing['description'];?>">
            </div>

            <div class="form-group">
                <label class="custom-label"><?php echo __('Description');?></label>
                <textarea name="overview" class="form-control" placeholder="<?php echo __('Description');?>"><?php echo $Listing['overview']; ?></textarea>
            </div>
