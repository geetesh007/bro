        ...
        <div id="requirements" class="step">
                        ...
                        <tr>
                            ...
                            <td class="status">
                                ...
                                <?php else: ?>
                                    <span class="disabled">
                                        <svg>
                                            <use xlink:href="../public/assets/img/sprite.svg#close" />
                                        </svg>
                                    </span>
            ...
            <div class="gotonext">
                <?php if ($installable): ?>
                    <a href="<?php echo APP.'/install?step=3';?>" class="btn btn-primary next-btn btn-lg px-5">Next</a>
                <?php else: ?>
                    <div class="bg-warning-lt alert">
